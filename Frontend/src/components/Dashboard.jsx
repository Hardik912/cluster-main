...
const blockchainNetworks = [
  ...
  { name: "Polygon", image: "/icons/polygon.png", position: "top-[40%] left-[50%]" },
...
const Dashboard = () => {
  ...
  return (
    <div className="relative flex items-center justify-center min-h-screen text-white overflow-hidden">
      ...
      >
        <div className="absolute inset-0 bg-opacity-90 bg-black opacity-60"></div>
      </div>

      {/* Blockchain Network Background Layer */}
      <div className="absolute inset-0 flex items-center justify-center">
        <div className="w-full h-full bg-gradient-to-b from-gray-800 to-black opacity-20 blur-3xl"></div>
      </div>
      ...
      {/* Main Score Card */}
      <motion.div
        className="relative z-10 bg-gradient-to-b from-gray-900 to-black bg-opacity-60 backdrop-blur-xl shadow-lg rounded-xl p-10 w-[400px] h-[500px] border border-cyan-400 hover:border-pink-500 transition-all duration-500 ease-in-out flex flex-col items-center justify-center"
        animate={{
          scale: [1, 1.02, 1],
          boxShadow: [
  ...
  onClick={() => navigate("/wallet")} // Redirect
>
  Connect Wallet
</motion.button>
